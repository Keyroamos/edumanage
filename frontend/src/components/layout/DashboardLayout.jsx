    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex overflow-hidden transition-colors duration-200">
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden relative ml-0 lg:ml-72">
                {/* Global Header */}
                <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 sticky top-0 z-30 px-4 py-2 flex justify-between items-center h-14 transition-colors duration-200">
